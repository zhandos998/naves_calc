                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-6">
                    ...
                    <x-dropdown align="right" width="64">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="'https://mosnavesi.ru/services/demontazh-navesov/'" target="_blank">Демонтаж навесов</x-dropdown-link>
                            <x-dropdown-link :href="'https://mosnavesi.ru/services/zamena-polikarbonata/'" target="_blank">Замена поликарбоната</x-dropdown-link>
                            <x-dropdown-link :href="'https://mosnavesi.ru/services/fermy-dlya-navesov/'" target="_blank">Фермы для навеса</x-dropdown-link>
                            <x-dropdown-link :href="url('/services/konteynernye-ploschadki')">Контейнерные площадки</x-dropdown-link>
                            <x-dropdown-link :href="url('/promoactions')">Акции</x-dropdown-link>
                            <x-dropdown-link :href="'https://mosnavesi.ru/garanties/'" target="_blank">Гарантии и Сертификаты</x-dropdown-link>
                            <x-dropdown-link :href="url('/articles')">Статьи</x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                </div>
                <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-6">
